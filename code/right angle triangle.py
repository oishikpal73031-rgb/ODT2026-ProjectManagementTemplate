...
X_LEN = float(input("Enter base length (inches): "))
Y_LEN = float(input("Enter height (inches): "))
...
def draw_triangle():
    ...
    move_line(*p1)   # start
    move_line(*p2)   # base
    move_line(*p3)   # vertical side
    move_line(*p1)   # diagonal back
